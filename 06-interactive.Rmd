...
<head>
  ...
  <body>
	<text id="format1" x="200" y="80">Comparing average income over the years (2000-2014) for two human classifier</text>
	</svg>
    
<script src="https://d3js.org/d3-scale-chromatic.v1.min.js"></script>
<br>
<br>
<text id="format1" x="200" y="80">Classifier1</text>
<select id="selectButton"></select>
<br>
<text id="format1" x="200" y="80">Classifier2</text>
